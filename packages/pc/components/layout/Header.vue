<template>
	<header>
		<div class="header-wrapper">
			<NuxtLink to="/"
				><img class="header-logo" src="/img/icon/logo-pc.png" alt="홈으로"
			/></NuxtLink>
			<div class="header-menu">
				<div class="header-menus">
					<NuxtLink
						:class="{ active: isCommission }"
						to="/market/commission/match"
						>마켓의뢰</NuxtLink
					>
					<NuxtLink :class="{ active: isAccept }" to="/market/accept/match"
						>마켓수임</NuxtLink
					>
					...
					<NuxtLink>
						...
						<div v-if="isAlarmShow" class="alarm-container">
							<div class="alarm-header">
								...
								<img
									src="/img/icon/close-gray.svg"
									class="alarm-header-close"
									@click="toggleAlarm"
								/>
							</div>
				...
				<div class="header-info-right">
					<div v-if="isCommission" class="header-sub-menus">
						<NuxtLink
							...
							:class="{
								active: [
									'/market/commission/match',
									'/market/commission/write',
						...
						<NuxtLink
							...
							:class="{
								active: route.fullPath.includes('/market/commission/progress'),
							}"
							>진행</NuxtLink
						>
					...
					<div v-if="isAccept" class="header-sub-menus">
						<NuxtLink
							...
							:class="{
								active:
									route.fullPath.includes('/market/accept/match') ||
									route.fullPath.includes('market/accept/write'),
							}"
							>매칭</NuxtLink
						>
						<NuxtLink
							...
							:class="{
								active: route.fullPath.includes('/market/accept/progress'),
							}"
							>진행</NuxtLink
						>
						<NuxtLink
							...
							:class="{
								active: route.fullPath.includes('/market/accept/complete'),
							}"
							>완료</NuxtLink
						>
						<NuxtLink
							to="/market/accept/setting"
							:class="{
								active: route.fullPath.includes('/market/accept/setting'),
							}"
							>설정</NuxtLink
						>
					</div>
