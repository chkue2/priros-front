			...
			<div class="market-container">
				...
				<div class="market-write-type">
					<div class="type-item active" @click="toggleEstimateReportModal">
						<span class="type-item-top">진행중이예요!</span>
					...
					<div class="type-item active" @click="toggleScheduleReportModal">
						<span class="type-item-tag">등기필보완 요청</span>
						<span class="type-item-top">진행중이예요!</span>
						<div class="type-item-bottom">
							<span>일정보고</span>
							<img src="/img/icon/arrow-upside-circle-black.svg" />
					...
					<div class="type-item active" @click="toggleTransferAccountModal">
						<span class="type-item-tag">송금대기</span>
						<span class="type-item-top">진행중이예요!</span>
						<div class="type-item-bottom">
							<span>송금요청</span>
							<img src="/img/icon/arrow-upside-circle-black.svg" />
					...
					<div class="type-item active" @click="toggleApplicationReportModal">
						<span class="type-item-tag">변동발생</span>
						<span class="type-item-top">진행중이예요!</span>
						<div class="type-item-bottom">
							<span>신청정보보고</span>
							<img src="/img/icon/arrow-upside-circle-black.svg" />
					...
					<div class="type-item" @click="toggleReceptionReportModal">
						<span class="type-item-top">STEP7</span>
						<div class="type-item-bottom">
							<span>접수보고</span>
							<img src="/img/icon/arrow-upside-circle-black.svg" />
						</div>
				...
				<div class="market-detail-info info--gray">
					...
					<div class="info-contents contents-3">
						<div class="info-contents-change-field">
							<input type="text" />
							<button>변경</button>
						</div>
					</div>
					...
					<div class="info-contents contents-3 flex-column align-start">
						<div class="info-contents-buttons">
							<button class="button--black">등기필정보 보완보고</button>
						</div>
						<div class="info-contents-area-container">
							<textarea
								class="contents-area"
								placeholder="등기신청서 작성 ID 및 작성번호를 입력하세요 (매도인별 식별번호 뒷자리 입력으로 대체 가능)"
							></textarea>
							<div class="contents-area-buttons">
				...
				<div class="market-detail-buttons">
					<button class="button--gray">수임철회</button>
					<button class="button--gray">사건위임</button>
				</div>
			</div>
