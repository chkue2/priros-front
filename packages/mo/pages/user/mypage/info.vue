        ...
        <div class="forms">
          ...
          <div class="form-group">
            ...
            <div class="form-input">
              ...
              <button class="form-button" @click="toggleAddressModal">
                검색
              </button>
            </div>
          </div>
...
const previewFileSrc = computed(() => {
  const type = ["png", "jpg", "jpeg"].includes(previewFileExt.value)
    ? "image"
    : "appication/pdf";
