<template>
  <div class="detail-case-top-container">
    ...
    <div class="detail-case-table">
      ...
      <div class="detail-case-table-contents flex-spacebetween ft-14 ft-bold">견적보고
        <button class="detail-case-button">견적확인</button>
      </div>
  ...
  <div class="detail-case-info-container">
    <div class="detail-case-table pd">
      ...
      <div class="detail-case-table-contents flex-spacebetween">매매계약서
        <button class="detail-case-button">확인</button>
      </div>
      ...
      <div class="detail-case-table-contents flex-spacebetween">박명수 법무사
        <button class="detail-case-button">확인</button>
      </div>
      <div class="detail-case-table-header">등록기관</div>
      <div class="detail-case-table-contents flex-spacebetween">국민은행
        <button class="detail-case-button">확인</button>
      </div>
  ...
  <div class="detail-case-bottom-container">
    <div class="detail-case-bottom-tabs">
      <p class="detail-case-bottom-tab" :class="{active: tab === 'changed'}" @click="handlerClickTab('changed')">
        변경내역</p>
      <p class="detail-case-bottom-tab" :class="{active: tab === 'memo'}" @click="handlerClickTab('memo')">메모</p>
      <p class="detail-case-bottom-tab" :class="{active: tab === 'processed'}" @click="handlerClickTab('processed')">
        처리내역</p>
...
const tradeCaseId = computed(() => route.params.id);
